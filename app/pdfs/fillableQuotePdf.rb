class QuickQuotePdf
  ...
  def get_field_names 
    ...
    #puts pdftk.get_field_names
  end

  def template_path
    @template_path ||= "#{Rails.root}/lib/pdf_templates/QuickQuote-Output_v1.pdf" # makes assumption about template file path unless otherwise specified
  end
